...
template <class Scheduler, template <class EScheduler, typename T> class TaskStorageT, template <class E2Scheduler> class DefaultStrategy, uint8_t CallThreshold>
