...
inline ModularTaskStoragePerformanceCounters::ModularTaskStoragePerformanceCounters() {

}

inline ModularTaskStoragePerformanceCounters::ModularTaskStoragePerformanceCounters(ModularTaskStoragePerformanceCounters& other)
...
inline void ModularTaskStoragePerformanceCounters::print_headers() {
...
inline void ModularTaskStoragePerformanceCounters::print_values() {
	num_stolen.print("%d\t");
