...
template <class Scheduler, class LowerBound, class NextVertex, class SchedulingStrategy, size_t MAX_SIZE = 64>
...
template <class Scheduler, class LowerBound, class NextVertex, class SchedulingStrategy, size_t MAX_SIZE>
