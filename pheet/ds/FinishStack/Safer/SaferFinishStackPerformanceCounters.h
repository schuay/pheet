/*
 * SaferFinishStackPerformanceCounters.h
 *
...
#ifndef SAFERFINISHSTACKPERFORMANCECOUNTERS_H_
#define SAFERFINISHSTACKPERFORMANCECOUNTERS_H_
...
class SaferFinishStackPerformanceCounters {
public:
	typedef SaferFinishStackPerformanceCounters<Pheet> Self;

	SaferFinishStackPerformanceCounters() {}
	SaferFinishStackPerformanceCounters(Self& other)
...
template <class Pheet>
inline void SaferFinishStackPerformanceCounters<Pheet>::print_headers() {
...
template <class Pheet>
inline void SaferFinishStackPerformanceCounters<Pheet>::print_values() {
...
#endif /* SAFERFINISHSTACKPERFORMANCECOUNTERS_H_ */
