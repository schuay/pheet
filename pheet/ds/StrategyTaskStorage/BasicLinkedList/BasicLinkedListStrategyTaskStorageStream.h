...
public:
	...
	bool has_next() {
		...
		return bin < block->get_size() || (bin == block->get_max_size() && block->get_next() != nullptr);
...
template <class Pheet, class TaskStorage>
BasicLinkedListStrategyTaskStorageStream<Pheet, TaskStorage>::BasicLinkedListStrategyTaskStorageStream(TaskStorage& task_storage)
...
template <class Pheet, class TaskStorage>
BasicLinkedListStrategyTaskStorageStream<Pheet, TaskStorage>::~BasicLinkedListStrategyTaskStorageStream() {
...
template <class Pheet, class TaskStorage>
inline void
BasicLinkedListStrategyTaskStorageStream<Pheet, TaskStorage>::check_current_view() {
