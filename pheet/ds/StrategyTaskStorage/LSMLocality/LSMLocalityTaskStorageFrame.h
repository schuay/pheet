...
#ifndef LSMLOCALITYTASKSTORAGEFRAME_H_
#define LSMLOCALITYTASKSTORAGEFRAME_H_
...
class LSMLocalityTaskStorageFrame {
public:
	LSMLocalityTaskStorageFrame()
	:phase(0) {
...
class LSMLocalityTaskStorageFrameRegistration {
public:
	LSMLocalityTaskStorageFrameRegistration()
 ...
 */
template <class Pheet>
size_t LSMLocalityTaskStorageFrame<Pheet>::wraparound = std::numeric_limits<size_t>::max() >> 1;


template <class Frame>
struct LSMLocalityTaskStorageFrameReuseCheck {
...
#endif /* LSMLOCALITYTASKSTORAGEFRAME_H_ */
