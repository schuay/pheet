/*
 * ArrayListStrategyTaskStorageControlBlock.h
 *
...
#ifndef LINKEDARRAYLISTSTRATEGYTASKSTORAGECONTROLBLOCK_H_
#define LINKEDARRAYLISTSTRATEGYTASKSTORAGECONTROLBLOCK_H_
...
struct ArrayListStrategyTaskStorageControlBlockItem {
	// First index in data
	size_t offset;
...
template <class Storage>
class ArrayListStrategyTaskStorageControlBlock {
public:
	typedef ArrayListStrategyTaskStorageControlBlock<Storage> ThisType;
	typedef ArrayListStrategyTaskStorageControlBlockItem<Storage> Item;

	ArrayListStrategyTaskStorageControlBlock();
	~ArrayListStrategyTaskStorageControlBlock();
...
template <class Storage>
ArrayListStrategyTaskStorageControlBlock<Storage>::ArrayListStrategyTaskStorageControlBlock()
...
template <class Storage>
inline bool ArrayListStrategyTaskStorageControlBlock<Storage>::try_register_iterator() {
...
template <class Storage>
inline void ArrayListStrategyTaskStorageControlBlock<Storage>::deregister_iterator() {
	SIZET_ATOMIC_ADD(&num_passed_iterators, 1);
}

template <class Storage>
inline ArrayListStrategyTaskStorageControlBlockItem<Storage>* ArrayListStrategyTaskStorageControlBlock<Storage>::get_data() {
	return data;
}

template <class Storage>
inline size_t ArrayListStrategyTaskStorageControlBlock<Storage>::get_length() {
	return length;
}

template <class Storage>
inline size_t ArrayListStrategyTaskStorageControlBlock<Storage>::get_new_item_index() {
	return new_item_index;
}

template <class Storage>
void ArrayListStrategyTaskStorageControlBlock<Storage>::clean_item(size_t item) {
	size_t limit = data[item].offset + Storage::block_size;
	clean_item_until(item, limit);
}

template <class Storage>
void ArrayListStrategyTaskStorageControlBlock<Storage>::clean_item_until(size_t item, size_t limit) {
...
template <class Storage>
void ArrayListStrategyTaskStorageControlBlock<Storage>::finalize() {
	pheet_assert(num_iterators == num_passed_iterators);
	delete[] data;
}

template <class Storage>
void ArrayListStrategyTaskStorageControlBlock<Storage>::finalize_item(size_t item, std::vector<typename Storage::Item*>& block_reuse, size_t max_reuse) {
	pheet_assert(num_iterators == num_passed_iterators);
	size_t limit = data[item].offset + Storage::block_size;
...
template <class Storage>
void ArrayListStrategyTaskStorageControlBlock<Storage>::finalize_item_until(size_t item, size_t limit, std::vector<typename Storage::Item*>& block_reuse, size_t max_reuse) {
	pheet_assert(num_iterators == num_passed_iterators);
	size_t offset = data[item].offset;
...
template <class Storage>
void ArrayListStrategyTaskStorageControlBlock<Storage>::finalize_unused_item(size_t item, std::vector<typename Storage::Item*>& block_reuse, size_t max_reuse) {
	pheet_assert(num_iterators == num_passed_iterators);
	if(block_reuse.size() < max_reuse) {
		block_reuse.push_back(data[item].data);
	}
...
template <class Storage>
size_t ArrayListStrategyTaskStorageControlBlock<Storage>::configure_as_successor(ThisType* prev, std::vector<typename Storage::Item*>& block_reuse) {
...
template <class Storage>
void ArrayListStrategyTaskStorageControlBlock<Storage>::init_empty(size_t offset, std::vector<typename Storage::Item*>& block_reuse) {
	pheet_assert(num_iterators == std::numeric_limits<size_t>::max());
	pheet_assert(num_passed_iterators == 0);
...
template <class Storage>
bool ArrayListStrategyTaskStorageControlBlock<Storage>::try_cleanup(std::vector<typename Storage::Item*>& block_reuse, size_t max_reuse) {
	size_t ni = num_iterators;
...
#endif /* LINKEDARRAYLISTSTRATEGYTASKSTORAGECONTROLBLOCK_H_ */
