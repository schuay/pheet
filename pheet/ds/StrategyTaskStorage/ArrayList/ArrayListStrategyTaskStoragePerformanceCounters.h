/*
 * ArrayListStrategyTaskStoragePerformanceCounters.h
 *
...
#ifndef ARRAYLISTSTRATEGYTASKSTORAGEPERFORMANCECOUNTERS_H_
#define ARRAYLISTSTRATEGYTASKSTORAGEPERFORMANCECOUNTERS_H_

namespace pheet {

template <class Pheet>
class ArrayListStrategyTaskStoragePerformanceCounters {
public:
	ArrayListStrategyTaskStoragePerformanceCounters();
	ArrayListStrategyTaskStoragePerformanceCounters(ArrayListStrategyTaskStoragePerformanceCounters& other);
	~ArrayListStrategyTaskStoragePerformanceCounters();
...
template <class Pheet>
inline ArrayListStrategyTaskStoragePerformanceCounters<Pheet>::ArrayListStrategyTaskStoragePerformanceCounters() {

}

template <class Pheet>
ArrayListStrategyTaskStoragePerformanceCounters<Pheet>::ArrayListStrategyTaskStoragePerformanceCounters(ArrayListStrategyTaskStoragePerformanceCounters& other)
...
template <class Pheet>
void ArrayListStrategyTaskStoragePerformanceCounters<Pheet>::print_headers() {
...
template <class Pheet>
void ArrayListStrategyTaskStoragePerformanceCounters<Pheet>::print_values() {
...
#endif /* ARRAYLISTSTRATEGYTASKSTORAGEPERFORMANCECOUNTERS_H_ */
