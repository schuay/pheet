/*
 * KDelayedLSMLocalityTaskStorageFrame.h
 *
...
#ifndef KDELAYEDLSMLOCALITYTASKSTORAGEFRAME_H_
#define KDELAYEDLSMLOCALITYTASKSTORAGEFRAME_H_
...
class KDelayedLSMLocalityTaskStorageFrame {
public:
	KDelayedLSMLocalityTaskStorageFrame()
	:phase(0) {
...
class KDelayedLSMLocalityTaskStorageFrameRegistration {
public:
	KDelayedLSMLocalityTaskStorageFrameRegistration()
 ...
 */
template <class Pheet>
size_t KDelayedLSMLocalityTaskStorageFrame<Pheet>::wraparound = std::numeric_limits<size_t>::max() >> 1;


template <class Frame>
struct KDelayedLSMLocalityTaskStorageFrameReuseCheck {
...
#endif /* KDELAYEDLSMLOCALITYTASKSTORAGEFRAME_H_ */
